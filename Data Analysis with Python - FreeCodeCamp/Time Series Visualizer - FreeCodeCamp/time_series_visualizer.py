...
def draw_box_plot():
    ...
    ax1 = sns.boxplot(data=df_box, x='year', y='value', ax=ax1, palette=sns.color_palette())
    ax1.set_ylabel('Page Views')
    ax1.set_xlabel('Year')
    ax1.set_title('Year-wise Box Plot (Trend)')

    ax2 = sns.boxplot(data=df_box, x='month', y='value', ax=ax2, order=mon_order, palette=sns.color_palette())
